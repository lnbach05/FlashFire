...
class hblNet(nn.Module):
    def __init__(self, width, height):
        ...
        #Convolution Layers
        self.conv_1 = nn.Conv2d(3, 16, kernel_size=(5, 5), stride=(2, 2))
        self.conv_2 = nn.Conv2d(16, 32, kernel_size=(3, 3), stride=(2, 2))
        self.conv_3 = nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(2, 2))
