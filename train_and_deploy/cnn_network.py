...
class OptimizedDonkeyNet(nn.Module):
    ...
    def __init__(self):
        super(OptimizedDonkeyNet, self).__init__()
        self.conv24 = nn.Conv2d(3, 24, kernel_size=(5, 5), stride=(2, 2))
        self.bn24 = nn.BatchNorm2d(24) #implement batch normalization to accelerate convergence
        self.conv32 = nn.Conv2d(24, 32, kernel_size=(5, 5), stride=(2, 2))
    ...
    def forward(self, x):
        ...
        x = self.relu(self.bn64_5(self.conv64_5(x)))
